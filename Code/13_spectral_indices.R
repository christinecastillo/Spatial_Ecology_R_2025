# Spectral indices from satellites images
...
im.plotRGB(m1992, r=1, g=2, b=3)  # El NIR es rojo
im.plotRGB(m1992, r=2, g=1, b=3)  # El NIR es verde 
...
dvi2006 = m2006[[1]] - m2006[[2]] / (m2006[[1]] + m2006[[2]])
